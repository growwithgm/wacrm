  ...
  return (
    <section className="flex h-full flex-col rounded-xl border border-border bg-card">
      <header className="flex items-center justify-between border-b border-border px-5 py-4">
        <div>
          <h2 className="text-sm font-semibold text-card-foreground">Conversations Over Time</h2>
      ...
      <footer className="flex items-center gap-4 border-t border-border px-5 py-3 text-xs text-muted-foreground">
        <LegendDot color="var(--chart-5)" label="Incoming" />
  ...
  return (
    <div ref={wrapRef} className="relative w-full">
        ...
        {hover !== null && (
          <g pointerEvents="none">
            <line
              ...
              strokeDasharray="3 3"
            />
            <circle cx={hoverX} cy={yFor(data[hover.idx].incoming)} r={3.5} fill="var(--chart-5)" />
      ...
      {hovered && hover !== null && (
        ...
        >
          <div className="font-medium text-card-foreground">{longDayLabel(hovered.day)}</div>
