...
export default function InboxPage() {
  ...
  return (
    // Fills the shell's full-bleed content area (the shell drops padding +
    // outer scroll for /inbox). h-full + the flex column below give the four
    // panels a fixed, non-overlapping layout that scrolls internally.
